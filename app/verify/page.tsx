    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-sm w-full bg-white rounded-2xl shadow-md p-8">
        <div className="flex justify-center mb-6">
          <span className="text-2xl font-bold" style={{ color: '#1D4ED8' }}>USAL Verify</span>
        </div>
        <div className="flex justify-center mb-5">
          <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center">
            <CheckCircle className="w-8 h-8" style={{ color: '#1D4ED8' }} strokeWidth={1.5} />
          </div>
        </div>
        ...
        <button
          ...
          style={{ backgroundColor: isRedirecting ? undefined : '#1D4ED8' }}
        >
          {isRedirecting ? (
        ...
        <p className="text-xs text-gray-400 text-center mt-6">Secured by USAL Verify</p>
      </div>
    </div>
  );
}
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="animate-spin rounded-full h-10 w-10 border-b-2" style={{ borderColor: '#1D4ED8' }} />
      </div>
    }>
      <VerifyPageContent />
    </Suspense>
