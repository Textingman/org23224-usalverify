        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto" style={{ color: '#6B7280' }}>
              USAL Verify is an online gaming platform where every game, quest, and challenge you complete earns you real aura points and rewards. We built this for players who want more than just fun — they want to level up.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-4" style={{ color: '#6B7280' }}>
              Gaming should reward you. We built USAL Verify because players deserve a platform where their time, skill, and dedication actually earn them something — aura points, prestige, and exclusive rewards.
            </p>
            <p className="text-lg mb-4" style={{ color: '#6B7280' }}>
            ...
            <p className="text-lg" style={{ color: '#6B7280' }}>
              Join thousands of players already earning aura on USAL Verify. Your next quest is waiting.
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#DBEAFE' }}>
                  <Gamepad2 className="w-5 h-5" style={{ color: '#1D4ED8' }} />
                </div>
                <div className="ml-4">
