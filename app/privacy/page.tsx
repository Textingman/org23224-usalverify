      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            USAL Verify ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service and website at www.usalverify.com. By using our service, you agree to the collection and use of information in accordance with this policy.
          </p>
          ...
          <p className="mb-4" style={{ color: '#6B7280' }}>
            If you opt in to receive SMS messages from USAL Verify, the following terms apply:
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2" style={{ color: '#6B7280' }}>
            ...
            <li>To opt out, reply STOP to any message. To get help, reply HELP or contact us at support@usalverify.com.</li>
          ...
          <p className="mb-6" style={{ color: '#6B7280' }}>
            ...
            Email: <a href="mailto:support@usalverify.com" style={{ color: '#1D4ED8' }}>support@usalverify.com</a>
          </p>
        </div>
      </section>
      <Footer />
