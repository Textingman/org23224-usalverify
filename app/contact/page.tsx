          ...
          <div>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button type="submit" disabled={submitting} className="w-full py-3 px-6 rounded-lg text-white font-semibold transition-opacity" style={{ backgroundColor: submitting ? '#9CA3AF' : '#1D4ED8', cursor: submitting ? 'not-allowed' : 'pointer' }}>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@usalverify.com" className="text-base font-medium hover:underline" style={{ color: '#1D4ED8' }}>support@usalverify.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>USAL Verify<br />838 Walker Road, Suite 21-2<br />Dover, Delaware 19904</p>
                </div>
                <div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm" style={{ color: '#6B7280' }}>No. We do not sell or share your mobile number with third parties for marketing. See our <a href="/privacy" className="font-medium hover:underline" style={{ color: '#1D4ED8' }}>Privacy Policy</a>.</p>
                </div>
              </div>
            </div>
          </div>
